...
$routes->get('/loginsiswa', 'siswa::log');
$routes->post('/loginsiswa', 'siswa::log');
$routes->get('/dashboardsiswa', 'siswa::dashboard');
$routes->get('/siswahome', 'siswa::home');
$routes->get('/petugashome', 'PetugasController::home');
$routes->get('/siswa/logout', 'siswa::logout');
$routes->post('/siswa/logout', 'siswa::logout');
...
$routes->post('/petugas/logout', 'PetugasController::logout');
...
$routes->get('/siswa/form-histori', 'siswa::history');
$routes->post('/siswa/form-histori', 'siswa::history');
...
$routes->get('/laporan/excel/(:any)', 'Laporan::exel',['filter'=>'otentifikasi']);

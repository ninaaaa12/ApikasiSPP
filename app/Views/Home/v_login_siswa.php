...
<form class="form-signin" method="POST" action="/siswa/login">
  <img class="mb-4" src="/logo-mts.png" class="img-thumbnail">
  ...
  <button class="btn btn-lg btn-info btn-block" type="submit"><i class="fas fa-sign-in-alt"></i> LOGIN </button>
  <p class="mt-5 mb-3 text-muted">MTS NEGERI 2 KUNINGAN</p>
</form>

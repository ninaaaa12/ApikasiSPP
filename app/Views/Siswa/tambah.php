...
<div class="form-group">
    ...
    <input type="text" name="txtPassword" class="form-control" placholder="Masukan Password Anda" autocomplete="off" required/>
</div>
...
<div class="form-group">
    <label class="font-weight-bold">Bayar</label>

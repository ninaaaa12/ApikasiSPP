    ...
    <div class="col-md-6">
        ...
        <form method="POST" action="/bayar/simpan">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?= date('d'); ?>" readonly>
            </div>

            <div class="form-group">
                <label class="font-weight-bold">Bulan Bayar</label>
                <input type="text" class="form-control" value="<?= date('M'); ?>" readonly>
            </div>
            ...
            <div class="form-group">
                <button class="btn btn-success btn-sm" id="btnSimpan" disabled>Simpan Pembayaran</button>
            </div>
        </form>
